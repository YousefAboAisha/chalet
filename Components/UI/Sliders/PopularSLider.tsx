      ...
      {PopularData.map((elem, index) => {
        return (
          <div className="relative group mx-2" key={index}>
            ...
            {/* <div className="absolute group-hover:opacity-100 opacity-100 duration-500 bottom-0 left-0 min-h-1/4 w-full text-text_dark bg-[#0000002a] backdrop-blur-sm p-2 rounded-b-2xl">
