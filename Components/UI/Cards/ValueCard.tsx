...
const ValueCard = ({ Icon, title, details }: SkillCardProps) => {
  return (
    <div className="relative full-theme flex flex-col justify-center items-center gap-1 rounded-xl p-4 duration-500 shadow-lg hover:border hover:border-primary hover:-translate-y-1">
